...
label = Label(root, text="Whatsapp Otomasyon", font="bold",
...
label = Label(
    root, text="Telefon Numarası: Format [+]", font=10, fg="white", bg="black")
...
def whatsup():
   try:
      ...
      messagebox.showerror("hata", "Lütfen Ayrıntıları Girin")
...
label = Label(root, text="Mesaj", font=20, fg="white", bg="black")
label.grid(row=1, padx=10, pady=10)
label.place(x=10,
            y=160)
...
send = Button(root, font="30", width=40, text="Gönder",
